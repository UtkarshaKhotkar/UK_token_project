...
// Mine UTK Tokens for the caller
#[ic_cdk::update]
fn mine_tokens(amount: u64) -> TokenResult<String> {
    ...
    Ok(format!("Mined {} UTK Tokens.", amount))
}

// Send UTK Tokens from caller to receiver
#[ic_cdk::update]
fn send_tokens(receiver: Principal, amount: u64) -> TokenResult<String> {
    ...
    Ok(format!("Sent {} UTK Tokens to {}.", amount, receiver.to_text()))
}

// Sell UTK Tokens (burn from caller's balance)
#[ic_cdk::update]
fn sell_tokens(amount: u64) -> TokenResult<String> {
    ...
    Ok(format!("Sold {} UTK Tokens.", amount))
}
